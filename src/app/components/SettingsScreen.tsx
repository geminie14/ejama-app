...
export function SettingsScreen({
  ...
  useEffect(() => {
    // keep in sync when props arrive/refresh
  ...
  const handleFileSelect = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      reader.onloadend = async () => {
        ...
        // Update user metadata so it persists
        ...
        <div className="space-y-4">
          <Card className="p-6 bg-white">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-lg" style={{ color: "#594F62" }}>
                Profile
              </h3>
              <Button variant="ghost" size="sm" onClick={() => setShowProfileEdit(!showProfileEdit)}>
              ...
              <div className="flex-1">
                {showProfileEdit ? (
                  <div className="space-y-3">
                    ...
                    <Button onClick={handleUpdateName} style={{ backgroundColor: "#A592AB", color: "white" }}>
                      Save Changes
                    </Button>
                  </div>
                ) : (
                  <>
                    <h4 className="font-medium" style={{ color: "#594F62" }}>
                      {editedName || "User"}
                    </h4>
          ...
          <Card className="p-6 bg-white">
            <button onClick={handleLogout} className="flex items-center space-x-4 w-full text-left hover:opacity-70 transition-opacity">
