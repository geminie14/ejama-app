...
export function CommunityScreen({
  ...
  const loadAnsweredQuestions = async () => {
    ...
    try {
      ...
      url.searchParams.set("filter", qaFilter);
  ...
  return (
    <div className="min-h-screen bg-[#E7DDFF] p-4">
      <div className="max-w-xl mx-auto">
          ...
          <div className="mt-4 space-y-4">
            <Card className="p-4 bg-white space-y-3">
              <div>
                ...
                <p className="text-sm mt-1" style={{ color: "#776B7D" }}>
                  Your name won’t be shown. Answers appear in “Browse Answered Questions”.
                </p>
              </div>
        ...
        {/* ✅ VIEW: Browse (THIS is where answers are viewed) */}
            ...
            <Card className="p-4 bg-white space-y-3">
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="text-sm mt-1" style={{ color: "#776B7D" }}>
                    This is where answers will show after the team responds.
                  </p>
                </div>
